...
CREATE TABLE SFX.t_viajes (
	...
	Via_Cia_ID_Procedencia		int,
	Via_Cia_ID_Arribo			int,
...
ALTER TABLE SFX.t_viajes
ADD CONSTRAINT FK_t_viajes_03 FOREIGN KEY (Via_Cia_ID_Procedencia) 
    REFERENCES SFX.t_ciudades_aeropuertos (Cia_ID) 
--Agregamos Foreign Key a tabla "Viajes 04"
ALTER TABLE SFX.t_viajes
ADD CONSTRAINT FK_t_viajes_04 FOREIGN KEY (Via_Cia_ID_Arribo) 
    REFERENCES SFX.t_ciudades_aeropuertos (Cia_ID) 
